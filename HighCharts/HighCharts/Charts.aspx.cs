...
namespace HighCharts
{
    public partial class Charts : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.SchoolName = "Abraham Lincon";
            this.PopulateHighCharts();
        }

        public void PopulateHighCharts()
        {
            UserProgram greProgram = new UserProgram() { ID = "1", Name = "GRE", Score = 25 };
            ...
            UserProgram gmatProgram = new UserProgram() { ID = "2", Name = "GMAT", Score = 25 };
            ...
            UserProgram kbrProgram = new UserProgram() { ID = "3", Name = "KBR", Score = 25 };
